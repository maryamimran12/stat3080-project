...
## Setting varying colors for levels of a continuous variable
...
#  plots that distinguish separate groups together. A multiple line     #
...
#  When groups are represented separately in a graphic, changes can    #
